...
const ui = {
  en: {
    ...
    cities: 'Which city?',
    citiesDescription: 'Name a city from a satellite image.',
    cityCount: '99 cities',
    cityStart: 'Start Which city?',
    ...
    cityIntroTitle: 'Name the city from straight above.',
    cityPhotoTitle: 'Read the satellite image',
    cityPhotoText: 'One unlabeled view, looking straight down, at the same scale each round.',
    cityGuessTitle: 'Name the city',
    cityGuessText: 'A district or the country does not count. Known names and minor typos do.',
    cityRecognised: (solved: number) => `${solved} of 10 cities recognised`,
    cityWho: 'Which city is this?',
    cityPrompt: 'One image. One city.',
    cityAnswerLabel: 'Name of the city',
    cityReveal: 'Reveal city',
    cityNext: 'Next city',
    cityMystery: 'Mystery city',
    cityPhotoAlt: 'Satellite image of a city',
    cityMapLabel: 'World map with the city',
  },
  de: {
    ...
    cities: 'Welche Stadt?',
    citiesDescription: 'Benenne eine Stadt anhand eines Satellitenbilds.',
    cityCount: '99 Städte',
    cityStart: 'Welche Stadt? starten',
    ...
    cityIntroTitle: 'Benenne die Stadt senkrecht von oben.',
    cityPhotoTitle: 'Das Satellitenbild lesen',
    cityPhotoText: 'Eine Ansicht ohne Beschriftung, senkrecht von oben, immer im gleichen Maßstab.',
    cityGuessTitle: 'Die Stadt benennen',
    cityGuessText: 'Ein Stadtteil oder das Land zählt nicht. Geläufige Namen und kleine Tippfehler gelten.',
    cityRecognised: (solved: number) => `${solved} von 10 Städten erkannt`,
    cityWho: 'Welche Stadt ist das?',
    cityPrompt: 'Ein Bild. Eine Stadt.',
    cityAnswerLabel: 'Name der Stadt',
    cityReveal: 'Stadt auflösen',
    cityNext: 'Nächste Stadt',
    cityMystery: 'Gesuchte Stadt',
    cityPhotoAlt: 'Satellitenbild einer Stadt',
    cityMapLabel: 'Weltkarte mit der Stadt',
  },
} as const
